    ...
    <section class="content">
        ...
        <form class="panel" method="post">
            <div class="form-grid">
                ...
                <div><label for="current_condition">Current Condition</label><select id="current_condition" name="current_condition"><option>Good</option><option>Worn</option><option>Damaged</option><option>Under Maintenance</option></select></div>
