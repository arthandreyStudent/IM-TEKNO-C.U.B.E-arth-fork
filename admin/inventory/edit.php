    ...
    <section class="content">
        ...
        <form class="panel" method="post">
            <div class="form-grid">
                ...
                <div><label for="current_condition">Current Condition</label><select id="current_condition" name="current_condition"><?php foreach(['Good','Worn','Damaged','Under Maintenance'] as $v): ?><option <?= $item['CurrentCondition']===$v?'selected':'' ?>><?= $v ?></option><?php endforeach; ?></select></div>
